<form action="/signup" method="POST">
    ...
    <div>
        ...
        <input type="text" name="razao_social" id="razao_social" value="{{old('razao_social')}}" data-pessoa="jurídica">
        <ul class="input-error">
    ...
    <div>
        ...
        <input type="text" name="cnpj" id="cnpj" value="{{old('cnpj')}}" title="CNPJ deve conter exatamente 14 dígitos" data-pessoa="jurídica">
        <ul class="input-error">
    ...
    <div>
        ...
        <input type="text" name="nome_fantasia" id="nome_fantasia" value="{{old('nome_fantasia')}}" required data-role="empresa">
        <ul class="input-error">
...
<script>
    ...
    [role, ...document.querySelectorAll('[name="is_pessoa_fisica"]')].forEach(
        el => el.addEventListener('change', toggleInputs)
    );
</script>
